...
describe TimeBanksController do
  ...
  describe "index" do
    ...
    it "gets all index" do
      ...
      assert_response :success
      assert_not_nil assigns(:time_banks)
      assert_equal assigns(:time_banks).to_a.count, 22
    end
  ...
  it "creates time_bank" do
    assert_difference('TimeBank.count') do
      post :create, time_bank: { member_id: @john, admin_id: @addy, 'date_worked(1i)'=> "2015", 'date_worked(2i)'=> "9",  'date_worked(3i)'=> "10", hours_worked: "1", approved: true, time_type: "store_shift" }
    end
  ...
  it "updates time_bank" do
    put :update, id: @john_cashier_approved, time_bank: { member_id: @john, admin_id: @addy, 'date_worked(1i)'=> "2015", 'date_worked(2i)'=> "9", 'date_worked(3i)'=> "10", hours_worked: "4", approved: true, time_type: "store_shift" }
    assert_redirected_to time_bank_path(assigns(:time_bank))
  end
